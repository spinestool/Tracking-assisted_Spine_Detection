function [waterShedSegmentation_all,L,waterShedLevels]=watershed_seg1(Img,maxNumberOfPixels)
graythresh_parameter=0.7;
...
imBW = im2bw(imEq, graythresh_parameter*graythresh(imEq));%Convert an image to a binary image, based on threshold
